...
TF_VAR_admin_dashboard_user= # enter a value for ADMIN_DASHBOARD_USER secret
TF_VAR_admin_dashboard_password= # enter a value for ADMIN_DASHBOARD_PASSWORD secret
